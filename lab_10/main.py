...
def main():
    ...
    while running:
        ...
        screen.fill(WHITE)
        visualizer_density.update(speed, iteration, boundary_condition, "density", animating)
        visualizer_ux.update(speed, iteration, boundary_condition, "ux", animating)
        visualizer_uy.update(speed, iteration, boundary_condition, "uy", animating)
        pygame.display.flip()
